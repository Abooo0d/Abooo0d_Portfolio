...
const About = () => {
  ...
  return (
    <div
      className={`flex flex-col bg-cover bg-repeat w-full pt-8 min-h-[100vh] justify-center items-center py-8 bg-fixed bg-center relative bg-[url(/src/Assets/aboutBgs.jpg)]`}
    >
