...
const Header = () => {
  return (
    <div
      className={`min-h-[100vh] gap-[20px] max-h-[100vh] scroll app__header flex items-center justify-start md:justify-center relative bg-cover bg-repeat bg-center flex-1 w-[100%] flex-col md:flex-row px-8 py-4 pt-24  bg-[url(/src/Assets/bgIMG.png)]`}
    >
