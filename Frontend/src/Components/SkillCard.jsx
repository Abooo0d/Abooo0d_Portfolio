...
const SkillCard = ({ Icon, color, index, shadow }) => {
  return (
    ...
    >
      <div
        className={`w-[100px] h-[100px] app__flex border-[2px] border-solid border-cu-white rounded-full cursor-pointer duration-300 ${color} ${shadow} hover:scale-110 animate-[bounce_1s_ease-in-out_2] `}
      >
